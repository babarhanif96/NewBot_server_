...
const generateSolidityFile = (_name, _symbol, _supply, _taxWallet,  website, twitter, github, discord) => {
    ...
    */
    ...
    contract MyToken is ERC20, Ownable{
        ...
        constructor (address _marketing , address _team , uint256 _liquidityFee , uint256 _marketingFee , uint256 _utilityFee , uint256 _teamFee , uint256 _burnFee ) ERC20("${_name}", "${_symbol}") {
